...
int main() {
    ...
    plist[@"Sockets"][@"LocalSSHListener"] = [[NSMutableDictionary alloc] init];
    plist[@"Sockets"][@"LocalSSHListener"][@"SockNodeName"] = @"localhost";
    plist[@"Sockets"][@"LocalSSHListener"][@"SockServiceName"] = @"2222";
